...
class Auction(db.Model):
	...
	# for instant buy listing lock
    lock_expiry = db.Column(db.DateTime, nullable=True)
    locked_by = db.Column(db.String(32), nullable=True)
    ...
    def to_dict(self, for_user=None):
        auction = {
            ...
            'locked_by': self.locked_by if self.locked_by else None,
