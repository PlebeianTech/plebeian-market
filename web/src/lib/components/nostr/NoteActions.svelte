...
<!-- ICONS -->
<div class="flex items-center w-full space-x-5 mb-2">
    <!-- LIKE -->
    <button class="btn btn-ghost flex tooltip tooltip-top" data-tip="like" on:click|preventDefault={() => pool.sendReaction(message, '+')}>
        {#if likeIsMine }
    ...
    <!-- REPLY -->
    <button class="btn btn-ghost flex tooltip tooltip-top" data-tip="reply"  on:click|preventDefault={() => setReplyToThisEvent(message)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <!-- REPOST -->
    <button class="btn btn-ghost flex tooltip tooltip-top" data-tip="repost">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
