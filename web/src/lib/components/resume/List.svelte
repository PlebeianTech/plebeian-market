...
<div class="mx-auto w-full">
    {#if Object.keys(resumes).length === 0}
        <Loading />
    {:else}
        <div class="m-4 p-1 pt-3 gap-1 max-w-fit bg-base-300 rounded-box flex flex-wrap items-center justify-center overflow-x-hidden">
            {#each Object.entries(skills) as [skill, count]}
                <div class="float badge badge-primary badge-lg mb-2 mr-1 cursor-pointer" class:badge-outline={skill !== skillFilter}
