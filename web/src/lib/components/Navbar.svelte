...
<div class="navbar bg-base-300">
    ...
    {/if}
    <div class="flex-1 invisible md:visible w-2/3">
        <a href={null} on:click|preventDefault={() => goto("/")} class="btn btn-ghost normal-case text-xl hidden md:inline">Home</a>
        <a href={null} on:click|preventDefault={() => goto("/about")} class="btn btn-ghost normal-case text-xl hidden md:inline">About</a>
        <a href={null} on:click|preventDefault={() => goto("/faq")} class="btn btn-ghost normal-case text-xl hidden md:inline">FAQ</a>
    </div>
            ...
            {#if $token && $user}
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0" class="mt-3 p-2 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
                        ...
                        <li><a href={null} on:click|preventDefault={() => goto(`/stores/${$user.nym}`)}>My store</a></li>
                        {#if $user.isModerator}
