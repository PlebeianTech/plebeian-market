    ...
    <div class="lg:w-2/3 py-2 px-4 mx-auto lg:flex lg:flex-row flex-col md:justify-between md:items-center">
        <div class="flex items-center justify-between">
            ...
            <div
                ...
                class="lg:hidden flex justify-end p-4"
            >
                <button
                    type="button"
        ...
        <div
            class:flex={showMobileMenu}
            class:hidden={!showMobileMenu}
            class="lg:flex lg:flex-row flex-col justify-center space-y-0 md:space-x-4"
        >
            <!-- LINKS -->
            <div class="lg:flex items-center w-full">
                {#if !isProduction()}
                    <div
                        class="lg:inline badge badge-primary ml-2 lg:my-0 hidden lg:block"
                    >
                        {getEnvironmentInfo()}
                    </div>
                {/if}
                ...
                <div class="lg:flex hidden">
                    <p>
                        <a
                            href="/marketsquare"
                            class="btn btn-ghost normal-case">Market Square</a
                        >
                    </p>
                    <p>
                        <a href="/skills" class="btn btn-ghost normal-case"
                            >Skills Market</a
                        >
                    </p>
                    <p>
                        <a href="/campaigns" class="btn btn-ghost normal-case"
                            >Campaigns</a
                        >
                    </p>
                    <p>
                    ...
                    <p>
                        <a href="/contact" class="btn btn-ghost normal-case"
                            >Contact</a
                        >
                    </p>
                    <p>
                        <a href="/about" class="btn btn-ghost normal-case"
                            >About</a
                        >
                    </p>
                    {#if !$token || !$user}
            ...
            <div class="lg:flex items-center justify-start space-x-4">
                ...
                <div
                    class="lg:dropdown lg:dropdown-end h-screen lg:h-fit"
                    on:click={hideMobileMenu}
                    on:keydown={hideMobileMenu}
                >
                    {#if $token && $user}
                        <label
                            role="button"
                            for={null}
                            tabindex="0"
                            class="btn btn-ghost btn-circle avatar hidden lg:block"
                            class:verified={$user.twitterUsernameVerified}
                            class:not-verified={!$user.twitterUsernameVerified}
                        >
                            <img
                    ...
                    <ul
                        role="menuitem"
                        tabindex="0"
                        class="p-2 shadow menu menu-compact dropdown-content bg-neutral text-white rounded-box w-60 z-40 float-right right-2"
                    >
                        {#if !$token || !$user}
                            <li class="block md:hidden md:h-0 text-primary">
                                <a
                                    href={null}
                                    class="modal-button cursor-pointer text-base"
                                    on:click={() =>
                                        AuthRequired.set({
                                            default: AuthBehavior.Login,
                                        })}
                                ...
                                >
                                    <svg
                                        ...
                                        stroke-width="1.5"
                                        stroke="text-primary"
                                        class="w-6 h-6 mr-1 stroke-primary"
                                    >
                                        <path
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
