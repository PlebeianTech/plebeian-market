...
<nav class="navbar flex items-center bg-base-300 flex-wrap">
    ...
    <div class="flex itemgs-center ml-auto">
        <label class="rounded mr-4 swap swap-rotate" on:click={toggleTheme} on:click={closeMenu}>
        ...
        <div class="pb-2 pt-1 pr-1" on:click={toggleMenu}>
