        ...
        <div class="grid w-full flex-grow gap-3 p-4 py-6 lg:p-14 lg:py-8 bg-base-300 rounded-xl rounded-tl-none rounded-tr-none md:shadow-xl items-center justify-center">
            ...
            {:else if activeTab===1}
                ...
                <div class="w-full flex items-center justify-center mt-3">
                    ...
                    {/if}
                    <button class="btn btn-warning btn-xs md:btn-md" on:click={generateNewNostrKey}>Generate a new Nostr key</button>
                </div>
...
{:else}
    ...
    <div class="flex justify-center items-center">
        <button id="close-window" class="btn btn-error btn-sm md:btn-md" on:click|preventDefault={closeLoginModal}>I understand, close this</button>
    </div>
{/if}
